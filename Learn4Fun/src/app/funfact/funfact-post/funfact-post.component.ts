...
import {FunfactDataService} from '../service/funfact-data.service';
...
export class FunfactPostComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.funfactDataService.addFunFact(new FunFact(
      ...
      [this.funfactForm.controls.image1.value.replace('C:\\fakepath\\', '../../assets/images/'),
        this.funfactForm.controls.image2.value.replace('C:\\fakepath\\', '../../assets/images/')],
